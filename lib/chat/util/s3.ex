defmodule Chat.Util.S3 do
  ...
  defp config do
    %{
      region: region(),
      access_key_id: Application.fetch_env!(:chat, :access_key_id),
      secret_access_key: Application.fetch_env!(:chat, :secret_access_key)
    }
  end
  ...
  def bucket do
    Application.fetch_env!(:chat, :bucket)
  end

  def region do
    Application.fetch_env!(:chat, :region)
  end

  def url do
    Application.fetch_env!(:chat, :url)
  end
